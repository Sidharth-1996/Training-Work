                    ...
                    users.map((val,index)=>{
                        return(
                            ...
                            <div className="col-4" key={index}>
                                <ReusableCard>
                                <UserCard2 id={val.id} name={val.name} email={val.email} pass={val.password} del={deleteUser}></UserCard2>
                                </ReusableCard>
                            </div>
